      ...
      <footer>
        <div className="fg">
          <div className="fc-col">
            ...
            <p style={{fontSize:13,lineHeight:1.7,marginBottom:16}}>India's AI-powered job platform. Find jobs, hire top candidates, and celebrate milestones — all in one place.</p>
            <div style={{display:'flex',gap:10,flexWrap:'wrap'}}>
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/company/121424037/" target="_blank" rel="noopener noreferrer" aria-label="HireHub360 on LinkedIn"
                style={{width:36,height:36,borderRadius:8,background:'#0a66c2',display:'flex',alignItems:'center',justifyContent:'center',transition:'opacity .15s'}}
              ...
              {/* Facebook */}
              <a href="https://www.facebook.com/hirehub360.in" target="_blank" rel="noopener noreferrer" aria-label="HireHub360 on Facebook"
                style={{width:36,height:36,borderRadius:8,background:'#1877f2',display:'flex',alignItems:'center',justifyContent:'center',transition:'opacity .15s'}}
                onMouseOver={e=>(e.currentTarget.style.opacity='.8')} onMouseOut={e=>(e.currentTarget.style.opacity='1')}>
              ...
              <a href="https://www.instagram.com/hirehub360" target="_blank" rel="noopener noreferrer" aria-label="HireHub360 on Instagram"
                style={{width:36,height:36,borderRadius:8,background:'linear-gradient(45deg,#f09433,#e6683c,#dc2743,#cc2366,#bc1888)',display:'flex',alignItems:'center',justifyContent:'center',transition:'opacity .15s'}}
                onMouseOver={e=>(e.currentTarget.style.opacity='.8')} onMouseOut={e=>(e.currentTarget.style.opacity='1')}>
              ...
              {/* Twitter/X */}
              <a href="https://twitter.com/hirehub360" target="_blank" rel="noopener noreferrer" aria-label="HireHub360 on X (Twitter)"
                style={{width:36,height:36,borderRadius:8,background:'#000',display:'flex',alignItems:'center',justifyContent:'center',transition:'opacity .15s'}}
                onMouseOver={e=>(e.currentTarget.style.opacity='.8')} onMouseOut={e=>(e.currentTarget.style.opacity='1')}>
